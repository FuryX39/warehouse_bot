    ...
    fetchJson("/api/warehouse/marketplaces/repricer/meta")
      .then(function (data) {
        ...
        root.innerHTML =
          ...
          "Цена меняется, если по карте ниже вида цен на 10% и более или выше на 30% и более. В колонки «Цена *» и «Минимум для акции» подставится рекомендуемая цена продавца.</p>" +
