...
_ASSETS = _PKG_ROOT / "assets" / "fonts"
...
def get_pdf_label_fonts() -> tuple[str, str]:
    ...
    if regular_path is None:
        logger.warning(
            "TTF с кириллицей не найден; используется Helvetica (русский текст может не отображаться). "
            "Положите DejaVuSans.ttf в assets/fonts/ или используйте Windows с Arial."
        )
